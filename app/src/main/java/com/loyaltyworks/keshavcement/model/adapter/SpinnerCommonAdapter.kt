...
class SpinnerCommonAdapter(context: Context, resource: Int, categoryList: List<CommonSpinner>): ArrayAdapter<CommonSpinner?>(context, resource, categoryList as List<CommonSpinner?>) {
