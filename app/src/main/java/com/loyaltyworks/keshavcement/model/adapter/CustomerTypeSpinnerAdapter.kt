...
class CustomerTypeSpinnerAdapter(context: Context, resource: Int, cityList: List<LstAttributesDetail>):
    ArrayAdapter<LstAttributesDetail?>(context, resource, cityList as List<LstAttributesDetail?>) {

        private val cityList: List<LstAttributesDetail> = cityList

    override fun getItemId(position: Int): Long {
        return position.toLong()
    }

    override fun getItem(position: Int): LstAttributesDetail? {
