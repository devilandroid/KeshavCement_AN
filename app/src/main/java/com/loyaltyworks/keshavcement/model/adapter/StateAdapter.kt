...
import com.loyaltyworks.keshavcement.model.State


class StateAdapter(context: Context, @LayoutRes resource: Int, locationStateCities: List<State>) : ArrayAdapter<State?>(context, resource, locationStateCities as List<State?>) {
    private val locationStateCities: List<State> = locationStateCities
