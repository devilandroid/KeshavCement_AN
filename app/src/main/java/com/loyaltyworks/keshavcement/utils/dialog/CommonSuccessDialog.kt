...
object CommonSuccessDialog {
    private var dialog: Dialog? = null

    interface CommonSuccessDialogCallBack {
        fun onOk()
    }

    fun showCommonSuccessDialog(
        context: Context,
        SuccessIcon:Boolean,
        title1:String,
        title2:String,
        commonSuccessDialogCallBack: CommonSuccessDialogCallBack,
    ) {
        ...
        ok.setOnClickListener {
            commonSuccessDialogCallBack.onOk()
            dialog?.dismiss()
            dialog = null
        }
