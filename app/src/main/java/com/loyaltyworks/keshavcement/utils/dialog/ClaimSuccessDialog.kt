...
object ClaimSuccessDialog {
    private var dialog: Dialog? = null

    interface ClaimSuccessDialogCallBack {
        fun onOk()
    }

    fun showClaimSuccessDialog(
        context: Context,
        SuccessIcon:Boolean,
        title1:String,
        title2:String,
        claimSuccessDialogCallBack: ClaimSuccessDialogCallBack,
    ) {
        ...
        ok.setOnClickListener {
            claimSuccessDialogCallBack.onOk()
            dialog?.dismiss()
            dialog = null
        }
